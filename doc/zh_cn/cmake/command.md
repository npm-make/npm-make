...
| CMAKE                      | target方法                       |
|----------------------------|--------------------------------|
| add_compile_definitions    | addCompileDefinitions（不支持全局范围） |
| add_compile_options        | addCompileOptions（不支持全局范围）     |
| add_dependencies           | addDependencies                |
| add_link_options           | addLinkOptions（不支持全局范围）        |
| include_directories        | addIncludeDirectories（不支持全局范围） |
| link_directories           | addLinkDirectories（不支持全局范围）    |
| link_libraries             | addLinkLibraries（不支持全局范围）      |
